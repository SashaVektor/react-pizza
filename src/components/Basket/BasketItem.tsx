...
const BasketItemBlock: React.FC<BasketItemProps> = ({ id, title, price, type, count, imageUrl, size }) => {
    ...
    const onClickRemove = () => {
        if (window.confirm('Подтверждаете удаление товара?')) { dispatch(removeItem(id)); }
    }
    return (
